...
```{r}
as_edgelist(routes_graph, names=T)
as_adjacency_matrix(routes_graph, attr="weight")
```

Or data frames describing nodes and edges:

```{r}
as_data_frame(routes_graph, what="edges")
as_data_frame(routes_graph, what="vertices")
```
...
```{r}
plot(routes_graph, vertex.shape="none", vertex.label=V(net)$name,
